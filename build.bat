...
set DEPS_DIR=C:\local\dev\prusa3d\PrusaSlicer-deps
...
echo Pause to Warn=%DO_WARN%
echo.

REM Warn user if the dependencies directory does not exist
if not exist "%DEPS_DIR%" (
    echo WARNING: Dependencies directory does not exist.
